<?php
$listUrl = CUR_URL . '?r=Role/LogPacketList';
$editUrl = '';
$delUrl  = '';

$fields = [
	['display' => '时间', 'name' => 'created_at', 'width' => 160],
	['display' => '玩家ID', 'name' => 'player_id', 'width' => 100],
	['display' => '协议号', 'name' => 'cmd', 'width' => 60],
	['display' => '备注', 'name' => 'data', 'align' => 'left', 'editor' =>['type'=>'text'],'height'=>100],
	['display' => '类型', 'name' => 'type', 'width' => 60],
